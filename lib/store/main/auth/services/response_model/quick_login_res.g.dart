...
part of 'quick_login_res.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

QuickLoginRes _$QuickLoginResFromJson(Map<String, dynamic> json) {
  return QuickLoginRes(
    data: json['data'] == null
        ? null
...
Map<String, dynamic> _$QuickLoginResToJson(QuickLoginRes instance) =>
    <String, dynamic>{
      'data': instance.data,
...
Data _$DataFromJson(Map<String, dynamic> json) {
  return Data(
    ...
    nickNamee: json['nickNamee'] as String?,
